...
describe('Load PGN (ICCS Format)', () => {
  ...
  const tests = [
    ...
    {
      // pgn with comments behind moves.
      fen: '2b2a3/3ka4/4b4/N8/8p/P5p2/4p4/9/4A4/4KAB2 b - - 0 43',
      pgn: [
        '[Game "Chinese Chess"]',
        '[Event "第一届全运会象棋决赛"]',
        ...
        '10. a3a4 ',
        '{挺边兵为边马开路，出马以后可以支援左车，是稳步进攻的着法} ',
        'h7h6 11. c6c8    b2e2   12. g0e2    b9b6  ',
        '{黑方进车抢占要道，埋伏退炮打死车的阴谋}',
        '13. a2b4    b6d6   14. d0e1    h6h8   15. c8c6    d6c6   ',
        '16. b4c6    h8i8 ',
        '{现在黑方平炮兑车，已为以后弃子夺先准备条件}',
        '17. h4f4  ',
        '{红方避兑占四路要道比车二平六稳健。如果改走车二平六，粗看可以得士，但右翼容易受黑方威胁。',
        ...
        '20. d7g7    i8i3 ',
        '{经过一阵搏杀，黑方实现了弃子夺先的战术计划}',
        '21. g7c7    i3i0   22. e2g0    g2g0   23. f8h8    g0g3   ',
        '24. h8h0    i0i3  ',
        '{黑方虽失一子，但车炮控制要道，况5卒俱全，乍看起来，红方并不利。观至此，不禁为红方捏把汗}',
        '25. c7b7  ',
        '{既可以退炮打中卒，有可以进马压象田，红方此时借对攻达到积极防守的目的}',
        ...
        ' e3e4  ',
        '{黑方退炮后，黑车即将调往右翼，给红方以巨大的威胁} ',
        '27. c6d8    d9e8   28. b7b9  c9a7 29. d8b7 e9d9 30. b7d6    e4e5   ',
        '31. b9b5    g3c3  32. b5e5    e6e5  ',
        '{为摆脱黑方的威胁，红方在以上几个回合中，马炮协作，以机警细致的着法步步紧迫黑方，终于兑去黑炮，平息了风波。',
        '现在的局势：红方车马兵单缺相，黑方车多卒士象全。以后双方残局着法工稳，终成正和} ',
        '33. h0h4    c3d3   34. d6c8    a7c9   35. h4h6    d3d8   36. h6c6    i6i5 ',
        '37. c8d6    d8b8   38. c6c5    e5e4   39. c5b5    b8b5   40. d6b5    e4e3 ',
        '41. b5c7    d9d8   42. e2g0    g5g4   43. c7a6    1/2-1/2'
      ],
      expect: true
    },
    {
      ...
      pgn: [
        ...
        '2. e2e7 g9e7 3. h2e2',
        '{　　再架中炮也属正着，如改走马八进七，则象５退７，红方帅府受攻，当然若红方仍再架中炮拼兑，那么失去双炮就难有作用了。}',
        'h9g7 4. h0g2 i9h9 5. b0c2 b9a7 6. a0d0 a9b9',
        '{　　聂棋圣仍按常规战法出动主力，却忽略了红方车塞象眼的凶着，应走车１进１。}',
        '7. d0d8',
        '{　　红车疾点象眼，局势霎时有剑拔弩张之感。这种对弈不能以常理揣度，红方只能像程咬金的三板斧一般猛攻一轮，若黑方防守得法则胜负立判。}',
        'b7b0',
        '{　　却说聂棋圣见我来势汹汹，神色顿时颇为凝重，一番思索之后沉下底炮以攻为守，果是身手不凡。此着如改走炮２平３，则帅五平六，炮３进５，车六进一，将５进１，炮五退二，黑方不易驾驭局面。}',
        '8. i0i4 b0a0 9. c2b4 a0a4 10. b4c2 a4a0 11. c2b4 b9b7',
        '{　　其实黑方仍可走炮１退４，红方若续走马八退七，则仍炮１进４不变作和，因黑右车叫将红可车六退九，故不算犯规。}',
        '12. e2b2 a0a4',
        '{　　劣着，导致失子，应走车２平３，红方如马八进六，则车３退１，红方无从着手。但有一点必须注意，黑车躲进暗道似与棋理相悖，故聂棋圣弃子以求局势缓和情有可原。}',
        '13. b2b7 a4i4 14. b7g7 h9h7 15. g7g8 h7h5 16. b4d5 i4e4',
        '17. g8i8 f9e8 18. d5f6 h5e5 19. e0d0',
        '{　　可直接走马四进三叫将再踩中象。}',
        'e5f5 20. f6g8 e9f9 21. d8d4 e6e5 22. d4d6 e4g4',
        '23. g8h6 e7g5 24. h6g4 e5e4 25. d6g6 e4f4 26. g6g9 f9f8',
        '27. g2h4 e8f7 28. h4g6 f8e8 29. g6h8',
        '{　　红方有些拖沓，应直接走车三平六立成绝杀。}',
        'e8e7 30. g9d9 f7e8 31. h8g6 f5f6 32. d9d6',
        '{　　再擒一车，以下着法仅是聊尽人事而已。}',
        'f6g6 33. d6g6 f4g4 34. g6e6 e7f7 35. d0e0 f7f8',
        '36. e6e8 f8f9 37. e8e9 f9f8 38. e9c9',
        '{　　至此，聂棋圣认负。与此同时，另一盘围棋对弈我被屠去一条大龙，已无力再战，遂平分秋色，皆大欢喜。}',
        '1-0'
      ],
      expect: true
